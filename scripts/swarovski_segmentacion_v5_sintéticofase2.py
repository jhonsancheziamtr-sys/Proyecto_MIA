# -*- coding: utf-8 -*-
"""Swarovski_Segmentacion_v5_SintéticoFase2.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yJfoE1LRQtwNLT2WnH62-QOWy8NZtNnQ
...
# ── 2.1 Carga desde GitHub (dataset sintético) ────────────────────────────────
GITHUB_RAW = 'https://raw.githubusercontent.com/jhonsancheziamtr-sys/Proyecto_MIA/main/data/Dataset_Sintetico_Joyeria.csv'

try:
    df = pd.read_csv(GITHUB_RAW)

    # CORRECCIÓN: el formato del dataset es YYYY-MM-DD (ISO 8601).
    # Con format='%Y-%m-%d' se parsean correctamente todos los registros.
    ...
    print(f"✅ Dataset cargado desde GitHub | Registros: {df.shape[0]:,} | Variables: {df.shape[1]}")
    ...
    raise Exception(
        f"❌ No se pudo cargar el dataset desde GitHub.\n"
        f"   URL: {GITHUB_RAW}\n"
        f"   Error: {e}\n"
        f"   Verifica que el archivo existe en /data/ y que el repositorio es público."
    )
...
fig.suptitle('EDA — Dataset Sintético | Visión General', fontsize=14, fontweight='bold')
